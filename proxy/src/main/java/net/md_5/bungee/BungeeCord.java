...
public class BungeeCord extends ProxyServer
{
    ...
    {
        return "supports versions: " + ProtocolConstants.SUPPORTED_VERSIONS.get( 0 ) + " - " + ProtocolConstants.SUPPORTED_VERSIONS.get( ProtocolConstants.SUPPORTED_VERSIONS.size() - 1 );
    }
